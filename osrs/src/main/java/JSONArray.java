...
public class JSONArray {
	...
	public JSONArray(Object var1) throws JSONException {
		...
		if (!var1.getClass().isArray()) {
			...
			for (int var3 = 0; var3 < var2; ++var3) {
				this.method2687(Array.get(var1, var3));
			}
	...
	public JSONArray(Object var1, boolean var2) throws JSONException {
		...
		if (!var1.getClass().isArray()) {
			...
			for (int var4 = 0; var4 < var3; ++var4) {
				this.method2687(new JSONObject(Array.get(var1, var4), var2));
			}
	...
	@ObfuscatedName("opt")
	public Object method2686(int var1) {
		return var1 >= 0 && var1 < this.length() ? this.myArrayList.get(var1) : null;
	}

	@ObfuscatedName("get")
	public Object method2685(int var1) throws JSONException {
		Object var2 = this.method2686(var1);
		if (var2 == null) {
	...
	public JSONArray method2687(Object var1) {
	...
	public boolean getBoolean(int var1) throws JSONException {
		Object var2 = this.method2685(var1);
	...
	public String getString(int var1) throws JSONException {
		return this.method2685(var1).toString();
	}
	...
	public String optString(int var1, String var2) {
		Object var3 = this.method2686(var1);
