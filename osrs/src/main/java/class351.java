...
public class class351 {
	...
	static {
		int var0 = 0;
		int var1 = 0;
		class346[] var2 = new class346[]{class346.field3135, class346.field3136};
		class346[] var3 = var2;

		for (int var4 = 0; var4 < var3.length; ++var4) {
			class346 var5 = var3[var4];
			if (var5.field3138 > var0) {
				var0 = var5.field3138;
			}

			if (var5.field3137 > var1) {
				var1 = var5.field3137;
			}
		}
	...
	static boolean method1840(String var0, int var1, String var2) {
		if (var1 == 0) {
			try {
			...
			try {
				Object var10 = class26.method101(class31.field85, var2, new Object[]{(new URL(class31.field85.getCodeBase(), var0)).toString()});
				return var10 != null;
