...
public class class30 {
	...
	static Script method125(int var0, int var1) {
	...
	static int method126(int var0, Script var1, boolean var2) {
		return 2;
	}
	...
	static final void method127(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		var5 = UserList.method2216(var5, var6);
		...
		if (Client.isCameraLocked) {
			class422.field3755 = var0 - var9;
			FadeInTask.field3706 = var1 - var10;
			ModeWhere.field3604 = var2 - var11;
			class165.field1420 = var3;
			class4.field3 = var4;
		} else {
		...
		if (Client.oculusOrbState == 1 && Client.staffModLevel >= 2 && Client.cycle % 50 == 0 && (class467.oculusOrbFocalPointX >> 7 != class136.localPlayer.x >> 7 || class36.oculusOrbFocalPointY >> 7 != class136.localPlayer.y >> 7)) {
			...
			var13 = (class467.oculusOrbFocalPointX >> 7) + AbstractArchive.baseX;
			var14 = (class36.oculusOrbFocalPointY >> 7) + class148.baseY;
			PacketBufferNode var15 = class503.getPacketBufferNode(ClientPacket.TELEPORT, Client.packetWriter.isaacCipher);
