...
public class DesktopPlatformInfoProvider implements class476 {
	...
	public PlatformInfo get() {
		...
		if (CollisionMap.field1871.startsWith("win")) {
			var1 = 1;
		} else if (CollisionMap.field1871.startsWith("mac")) {
			var1 = 2;
		} else if (CollisionMap.field1871.startsWith("linux")) {
			var1 = 3;
		} else {
			var1 = 4;
		}
		...
		String var26 = "";
		boolean var27 = false;
		return new PlatformInfo(var1, var28, var7, var8, this.field3915, this.field3916, this.field3914, false, var10, var11, var12, 0, var13, var14, var15, var16, 0, 0, 0, 0, var17, var18, var23, 0, "", "");
	}
	...
	void method2333(String var1) {
		...
		try {
			this.field3915 = Integer.parseInt(var2[1]);
			var2 = var2[2].split("_");
			this.field3916 = Integer.parseInt(var2[0]);
			this.field3914 = Integer.parseInt(var2[1]);
	...
	void method2335(String var1) {
		String[] var2 = var1.split("\\.");

		try {
			this.field3915 = Integer.parseInt(var2[0]);
			this.field3916 = Integer.parseInt(var2[1]);
			this.field3914 = Integer.parseInt(var2[2]);
		} catch (Exception var4) {
		}
	...
	public static IndexedSprite[] method2334(AbstractArchive var0, String var1, String var2) {
