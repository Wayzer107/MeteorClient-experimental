...
public class class467 {
	...
	static {
		field3901 = new int[32768];

		for (int var0 = 0; var0 < 32768; ++var0) {
			field3901[var0] = method2320(var0);
		}
	...
	static final int method2320(int var0) {
	...
	static void method2322() {
		if (field3899 == null) {
			field3899 = new int[65536];
	...
	public static int method2323(int var0) {
		return 255 - (var0 & 255);
	}
	...
	static int method2325(int var0, Script var1, boolean var2) {
		int var3;
		if (var0 == 3500) {
			...
			var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
			Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = Client.keyHandlerInstance.method1086(var3) ? 1 : 0;
			return 1;
		} else if (var0 == 3502) {
			var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
	...
	static final boolean method2326(Widget var0) {
		...
		if (var1 == 205) {
			...
			if (var1 >= 314 && var1 <= 323) {
				var2 = (var1 - 314) / 2;
				var3 = var1 & 1;
				Client.playerAppearance.method1683(var2, var3 == 1);
			}

			if (var1 == 324) {
				Client.playerAppearance.method1684(0);
			}

			if (var1 == 325) {
				Client.playerAppearance.method1684(1);
			}
