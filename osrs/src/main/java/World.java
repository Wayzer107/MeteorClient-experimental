...
public class World {
	...
	public static int method392(int var0, int var1, int var2, int var3, int var4, int var5) {
		if ((var5 & 1) == 1) {
			int var6 = var3;
			var3 = var4;
			var4 = var6;
	...
	static final void method393(byte[] var0, int var1, int var2, int var3, int var4, CollisionMap[] var5) {
		int var7;
		int var8;
	...
	static void method404() {
		...
		if (Login.Login_username.length() == 0) {
			...
			long var1;
			try {
				URL var3 = new URL(UrlRequest.method661("services", false) + "m=accountappeal/login.ws");
			...
			if (var1 == 0L) {
				...
				var26.encryptRsa(class72.field728, class72.field727);
				var9.writeByte(10);
				...
				VertexNormal.method1323(var9);
				var9.writeLong(var33.nextLong());
				var9.encryptRsa(class72.field728, class72.field727);
				...
				String var14 = class345.method1832(var13.array);

				byte var27;
				try {
					URL var15 = new URL(UrlRequest.method661("services", false) + "m=accountappeal/login.ws");
					...
					var17.write("data2=" + class497.method2455(var14) + "&dest=" + class497.method2455("passwordchoice.ws"));
					var17.flush();
			...
			switch(var0) {
			case 2:
				Actor.setLoginResponseString(Strings.field3412, Strings.field3419, Strings.field3410);
	...
	static final void method405(Player var0, int var1, int var2, MoveSpeed var3) {
		...
		if (var4 >= var6 && var4 < 104 - var6 && var5 >= var6 && var5 < 104 - var6) {
			if (var1 >= var6 && var1 < 104 - var6 && var2 >= var6 && var2 < 104 - var6) {
				...
				Client.field647.approxDestinationX = var1;
				Client.field647.approxDestinationY = var2;
				Client.field647.approxDestinationSizeX = 1;
				Client.field647.approxDestinationSizeY = 1;
				ApproximateRouteStrategy var9 = Client.field647;
				CollisionMap var11 = Client.collisionMaps[var0.plane];
				int[] var12 = Client.field589;
				int[] var13 = Client.field590;
				int var7 = WorldMapSprite.method1499(var4, var5, var8, var9, var11, true, var12, var13, class219.field1905[0]);
				int var14 = var7;
				if (var7 >= 1) {
					for (int var15 = 0; var15 < var14 - 1; ++var15) {
						var0.method501(Client.field589[var15], Client.field590[var15], var3);
					}
