...
class class313 implements Callable {
	...
	static Bounds field2821;
	@ObfuscatedName("io")
	static long field2820;
	// $FF: synthetic field
	@ObfuscatedSignature(
		descriptor = "Llc;"
	)
	...
	public Object call() {
		PriorityQueue var1 = this.this$0.field2787;
	...
	public static int method1646(byte[] var0, int var1) {
		return class358.method1864(var0, 0, var1);
	}
}
