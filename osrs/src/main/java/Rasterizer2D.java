...
public class Rasterizer2D extends DualNode {
	...
	@ObfuscatedName("ed")
	protected static void method2601(int[] var0, int var1, int var2, float[] var3) {
	...
	public static void method2624() {
		if (field4171 != null) {
			...
			if (Rasterizer2D_xClipStart == 0 && Rasterizer2D_xClipEnd == Rasterizer2D_width && Rasterizer2D_yClipStart == 0 && Rasterizer2D_yClipEnd == Rasterizer2D_height) {
				var0 = field4171.length;
				var1 = var0 - (var0 & 7);

				for (var2 = 0; var2 < var1; field4171[var2++] = 0.0F) {
					field4171[var2++] = 0.0F;
					field4171[var2++] = 0.0F;
					field4171[var2++] = 0.0F;
					field4171[var2++] = 0.0F;
	...
	public static void method2625() {
		if (field4171 != null) {
			int var0 = field4171.length;

			for (int var1 = 0; var1 < var0; ++var1) {
				if (var1 % Rasterizer2D_width < Rasterizer2D_width / 2 && field4171[var1] > 0.0F) {
					int var2 = (int)(255.0F * ClientPreferences.method546(field4171[var1]));
					Rasterizer2D_pixels[var1] = var2 << 16 | var2 << 8 | var2;
				}
			}
