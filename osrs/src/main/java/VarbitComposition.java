...
public class VarbitComposition extends DualNode {
	...
	static {
		...
		field1655 = new int[32];
		int var0 = 2;

		for (int var1 = 0; var1 < 32; ++var1) {
			field1655[var1] = var0 - 1;
			var0 += var0;
		}
	...
	static final void method996(Widget var0) {
		int var1 = var0.contentType;
		if (var1 == 324) {
			if (Client.field545 == -1) {
				Client.field545 = var0.spriteId2;
				Client.field542 = var0.spriteId;
			}

			if (Client.playerAppearance.field2900 == 1) {
				var0.spriteId2 = Client.field545;
			} else {
				var0.spriteId2 = Client.field542;
			}
