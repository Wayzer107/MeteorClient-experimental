...
public class Buffer extends Node {
	...
	public void writeCESU8(CharSequence var1) {
		...
		var5 = var9 - var7;
		this.offset = (var4 + var5 * 646629181) * -164706283;
	}
	...
	public void method2517(Buffer var1) {
	...
	public int writeCrc(int var1) {
		int var2 = class358.method1864(this.array, var1, this.offset);
		this.writeInt(var2);
		return var2;
	}
	...
	public boolean checkCrc() {
		this.offset -= 4;
		int var1 = class358.method1864(this.array, 0, this.offset);
	...
	public void writeMed0(int var1) {
		this.array[++this.offset - 1] = (byte)var1;
		this.array[++this.offset - 1] = (byte)(var1 >> 8);
		this.array[++this.offset - 1] = (byte)(var1 >> 16);
	}
	...
	static final void doCheat(String var0) {
		if (var0.equalsIgnoreCase("toggleroof")) {
			class150.clientPreferences.setRoofsHidden(!class150.clientPreferences.getRoofsHidden());
		...
		if (var0.startsWith("zbuf")) {
			boolean var1 = class306.method1584(var0.substring(5).trim()) == 1;
			TileItem.client.method152(var1);
			Rasterizer3D.method1162(var1);
		}
		...
		if (var0.equalsIgnoreCase("displayfps")) {
			class150.clientPreferences.method556();
		}

		if (var0.equalsIgnoreCase("renderself")) {
			Client.field382 = !Client.field382;
		}
		...
		if (Client.staffModLevel >= 2) {
			...
			if (var0.equalsIgnoreCase("fpson")) {
				class150.clientPreferences.method555(true);
			}

			if (var0.equalsIgnoreCase("fpsoff")) {
				class150.clientPreferences.method555(false);
			}
