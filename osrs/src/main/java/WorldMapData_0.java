...
public class WorldMapData_0 extends AbstractWorldMapData {
	...
	static void method1364(Font var0, Font var1) {
		int var4;
		int var5;
		if (class131.worldSelectBackSprites == null) {
			...
			if (!var3.isValidFileName("sl_back", "")) {
				...
				var2 = class453.method2294(var3, var4, var5);
			}
		...
		if (class292.worldSelectFlagSprites == null) {
			class292.worldSelectFlagSprites = DesktopPlatformInfoProvider.method2334(class386.archive8, "sl_flags", "");
		}

		if (class30.worldSelectArrows == null) {
			class30.worldSelectArrows = DesktopPlatformInfoProvider.method2334(class386.archive8, "sl_arrows", "");
		}

		if (MoveSpeed.worldSelectStars == null) {
			MoveSpeed.worldSelectStars = DesktopPlatformInfoProvider.method2334(class386.archive8, "sl_stars", "");
		}
		...
		if (MoveSpeed.worldSelectStars != null) {
			MoveSpeed.worldSelectStars[1].drawAt(Login.xPadding + 140, 1);
			var1.draw("Members only world", Login.xPadding + 152, 10, 16777215, -1);
			MoveSpeed.worldSelectStars[0].drawAt(Login.xPadding + 140, 12);
		...
		if (class131.worldSelectBackSprites != null) {
			...
			for (var16 = var15 * var5; var16 < World.World_count && var15 - Login.worldSelectPage < var4; ++var16) {
				...
				int var21 = 0;
				if (var17.isBeta()) {
					var20 = var17.isMembersOnly() ? class108.field1128 : class108.field1114;
				} else if (var17.isDeadman()) {
					var20 = var17.isMembersOnly() ? class108.field1123 : class108.field1113;
				} else if (var17.method399()) {
					var21 = 16711680;
					var20 = var17.isMembersOnly() ? class108.field1116 : class108.field1121;
				} else if (var17.method401()) {
					var20 = var17.isMembersOnly() ? class108.field1118 : class108.field1124;
				} else if (var17.isPvp()) {
					var20 = var17.isMembersOnly() ? class108.field1117 : class108.field1120;
				} else if (var17.method402()) {
					var20 = var17.isMembersOnly() ? class108.field1122 : class108.field1119;
				} else if (var17.method403()) {
					var20 = var17.isMembersOnly() ? class108.field1126 : class108.field1115;
				}

				if (var20 == null || var20.field1129 >= class131.worldSelectBackSprites.length) {
					var20 = var17.isMembersOnly() ? class108.field1127 : class108.field1125;
				}
				...
				if (MouseHandler.MouseHandler_x >= var12 && MouseHandler.MouseHandler_y >= var11 && MouseHandler.MouseHandler_x < var26 + var12 && MouseHandler.MouseHandler_y < var11 + var27 && var18) {
					...
					class131.worldSelectBackSprites[var20.field1129].drawTransOverlayAt(var12, var11, 128, 16777215);
					var14 = true;
				} else {
					class131.worldSelectBackSprites[var20.field1129].drawAt(var12, var11);
				}
