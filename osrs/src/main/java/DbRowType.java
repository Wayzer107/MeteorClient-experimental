...
public class DbRowType extends DualNode {
	...
	static AbstractArchive field4105;
	@ObfuscatedName("ay")
	@ObfuscatedSignature(
		descriptor = "Lld;"
	)
	...
	void method2489(Buffer var1, int var2) {
		if (var2 == 3) {
			int var3 = var1.readUnsignedByte();
			if (this.columnTypes == null) {
				this.columnTypes = new Object[var3][];
				this.field4106 = new int[var3][];
			}
			...
			for (int var4 = var1.readUnsignedByte(); var4 != 255; var4 = var1.readUnsignedByte()) {
				...
				this.columnTypes[var4] = class10.method30(var1, var6);
				this.field4106[var4] = var6;
			}
		} else if (var2 == 4) {
			this.tableId = var1.method2545();
		}
	...
	public static int method2486(float[] var0, int var1, float var2, boolean var3, float var4, boolean var5, float[] var6) {
		float var7 = 0.0F;
		...
		float var44 = (Math.abs(var2) + Math.abs(var4)) * (float)(var1 + 1) * class126.field1194;
		if (var7 <= var44) {
			return -1;
		} else {
			...
			if (var1 == 0) {
				...
				class453 var41 = new class453(var9, var1);
				...
				int var14 = method2486(var42, var1 - 1, var2, false, var4, false, var43);
				if (var14 == -1) {
					return 0;
				} else {
					boolean var15 = false;
					...
					for (int var20 = 0; var20 <= var14; ++var20) {
						...
						if (var20 == 0) {
							var16 = var2;
							var18 = class328.method1677(var9, var1, var2);
						...
						var17 = class328.method1677(var9, var1, var19);
						if (var15) {
							var15 = false;
							...
							float var24 = var16;
							float var25 = var19;
							float var26 = class328.method1677(var41.field3875, var41.field3876, var16);
							float var23;
							if (Math.abs(var26) < class126.field1194) {
								var23 = var16;
							} else {
								float var27 = class328.method1677(var41.field3875, var41.field3876, var19);
								if (Math.abs(var27) < class126.field1194) {
									var23 = var19;
								} else {
									float var28 = 0.0F;
									float var29 = 0.0F;
									...
									do {
										...
										float var38 = class126.field1195 * Math.abs(var25) + 0.0F;
										...
										if (var40) {
											...
											var27 = class328.method1677(var41.field3875, var41.field3876, var25);
