...
public class MusicTrack extends Node {
	...
	MusicTrack(Buffer var1) {
		this.field2826 = new NodeHashTable(16);
					...
					if (var68 == 23) {
						...
						if (var66 == 0) {
							...
							if (var71 > 0) {
								...
								class319 var73 = (class319)this.field2826.get((long)var72);
								if (var73 == null) {
									var73 = new class319(var65);
									this.field2826.put(var73, (long)var72);
								}

								var73.field2861.set(var74);
							}
						} else if (var66 == 1) {
							if (var69) {
