...
public class WorldMap {
	...
	public void init(AbstractArchive var1, AbstractArchive var2, AbstractArchive var3, Font var4, HashMap var5, IndexedSprite[] var6) {
		...
		int var7 = this.WorldMap_archive.getGroupId(WorldMapCacheName.field2449.name);
	...
	public void onCycle(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
		if (this.cacheLoader.isLoaded()) {
			...
			if (var3) {
				...
				List var10 = this.worldMapManager.method1447(this.centerTileX - var8 / 2 - 1, this.centerTileY - var9 / 2 - 1, var8 / 2 + this.centerTileX + 1, var9 / 2 + this.centerTileY + 1, var4, var5, var6, var7, var1, var2);
	...
	public void method2361(int var1, int var2, boolean var3, boolean var4) {
		long var5;
		label33: {
			var5 = class113.clockNow();
			...
			if (!this.hasTarget() && (var4 || var3)) {
				...
				if (!var7) {
					if (var4) {
						this.field3981 = var1;
						this.field3984 = var2;
						this.field3991 = this.centerTileX;
						this.field3982 = this.centerTileY;
					}

					if (this.field3991 != -1) {
						int var8 = var1 - this.field3981;
						int var9 = var2 - this.field3984;
						this.setWorldMapPosition(this.field3991 - (int)((float)var8 / this.zoomTarget), (int)((float)var9 / this.zoomTarget) + this.field3982, false);
					}
					break label33;
				}
			}
	...
	@ObfuscatedName("as")
	void method2362(int var1, int var2, boolean var3, long var4) {
		if (this.currentMapArea != null) {
			...
			if (this.mouseCoord != null && var3) {
				class213 var8 = SceneTilePaint.method1324();
				int var10;
				int var11;
				if (class158.method835() && var8.getKeyPressed(82) && var8.getKeyPressed(81)) {
					int var14 = this.mouseCoord.x;
					var10 = this.mouseCoord.y;
					var11 = this.mouseCoord.plane;
					PacketBufferNode var12 = class503.getPacketBufferNode(ClientPacket.TELEPORT, Client.packetWriter.isaacCipher);
					...
					boolean var9 = true;
					if (this.field3972) {
						var10 = var1 - this.field3985;
						var11 = var2 - this.field3992;
						if (var4 - this.field4012 > 500L || var10 < -25 || var10 > 25 || var11 < -25 || var11 > 25) {
							var9 = false;
						}
					}
	...
	public void method2369(int var1, int var2, int var3, boolean var4) {
	...
	public void method2375(WorldMapArea var1, Coord var2, Coord var3, boolean var4) {
		if (var1 != null) {
			if (this.currentMapArea == null || var1 != this.currentMapArea) {
				this.initializeWorldMapManager(var1);
			}
	...
	public void draw(int var1, int var2, int var3, int var4, int var5) {
		...
		if (var7 < 100) {
			...
			if (!this.elementsDisabled) {
				boolean var10 = false;
				if (var5 - this.field3996 > 100) {
					this.field3996 = var5;
					var10 = true;
				}

				this.worldMapManager.drawElements(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2, var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4, this.field4000, this.flashingElements, this.flashCycle, this.cyclesPerFlash, var10);
			}

			this.method2379(var1, var2, var3, var4, var8, var9);
			if (class158.method835() && this.showCoord && this.mouseCoord != null) {
	...
	boolean method2378(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.sprite == null) {
			return true;
			...
			if (this.worldMapManager.pixelsPerTile != this.cachedPixelsPerTile) {
				return true;
			} else if (this.field3997 != Client.field364) {
				return true;
	...
	void method2379(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (UserComparator7.field1171 != null) {
			...
			if (this.method2378(var8, var9, var13, var14, var3, var4)) {
				...
				UserComparator7.field1171.method1934(this.minCachedTileX, this.minCachedTileY, this.sprite, (float)this.cachedPixelsPerTile / var10);
				this.field3997 = Client.field364;
			...
			if (var10 == 1.0F) {
				this.sprite.method2659(var13, var14, 192);
			} else {
				this.sprite.method2662(var13, var14, (int)((float)var8 * var10), (int)((float)var9 * var10), 192);
			}
		}
	...
	void method2411() {
		this.field4000.clear();
		this.field4000.addAll(this.enabledElements);
		this.field4000.addAll(this.enabledElementIds);
	}
	...
	public void addElementMenuOptions(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.cacheLoader.isLoaded()) {
			...
			List var9 = this.worldMapManager.method1447(this.centerTileX - var7 / 2 - 1, this.centerTileY - var8 / 2 - 1, var7 / 2 + this.centerTileX + 1, var8 / 2 + this.centerTileY + 1, var1, var2, var3, var4, var5, var6);
			if (!var9.isEmpty()) {
	...
	public Coord method2413(int var1, Coord var2) {
		if (!this.cacheLoader.isLoaded()) {
			return null;
	...
	public AbstractWorldMapIcon iconStart() {
		if (!this.cacheLoader.isLoaded()) {
			...
			this.field4007 = new LinkedList();
			Iterator var2 = var1.values().iterator();

			while (var2.hasNext()) {
				List var3 = (List)var2.next();
				this.field4007.addAll(var3);
			}

			this.iconIterator = this.field4007.iterator();
	...
	public static SpritePixels SpriteBuffer_getSprite(AbstractArchive var0, int var1, int var2) {
		...
		return !var3 ? null : FileSystem.method905();
	}
}
