...
final class GrandExchangeOfferTotalQuantityComparator implements Comparator {
	...
	static void getLoginError(int var0) {
		...
		class129.updateGameState(10);
		boolean var3 = var1 != class93.method507();
		if (!var3 && Client.field644.method2597()) {
			class328.method1678(9);
		}
	...
	static final void method1911(boolean var0) {
		if (var0) {
			Client.field415 = Login.field739 ? class139.field1310 : class139.field1306;
		} else {
			Client.field415 = class150.clientPreferences.method575(Login.Login_username) ? class139.field1309 : class139.field1307;
		}
