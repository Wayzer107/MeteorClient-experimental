...
public abstract class AbstractArchive {
	...
	void decodeIndex(byte[] var1) {
		this.hash = class313.method1646(var1, var1.length);
		...
		if (var3 >= 5 && var3 <= 7) {
			...
			if (var3 >= 7) {
				this.groupCount = var2.method2542();
			} else {
			...
			if (var3 >= 7) {
				for (var7 = 0; var7 < this.groupCount; ++var7) {
					this.groupIds[var7] = var5 += var2.method2542();
			...
			if (var3 >= 7) {
				for (var7 = 0; var7 < this.groupCount; ++var7) {
					...
					for (var11 = 0; var11 < var9; ++var11) {
						var12 = this.fileIds[var8][var11] = var5 += var2.method2542();
						if (var12 > var10) {
							var10 = var12;
						}
					}
	...
	public byte[] takeFileEncrypted(int var1, int var2, int[] var3) {
		if (var1 >= 0 && var1 < this.files.length && this.files[var1] != null && var2 >= 0 && var2 < this.files[var1].length) {
			...
			byte[] var5 = class150.method785(this.files[var1][var2], false);
	...
	public boolean method1872(int var1) {
	...
	public byte[] getFile(int var1, int var2) {
		if (var1 >= 0 && var1 < this.files.length && this.files[var1] != null && var2 >= 0 && var2 < this.files[var1].length) {
			...
			byte[] var4 = class150.method785(this.files[var1][var2], false);
			return var4;
		} else {
			return null;
		}
		...
		if (this.groups[var1] == null) {
			...
			if (var6) {
				...
				if (var2 != null && (var2[0] != 0 || var2[1] != 0 || var2[2] != 0 || var2[3] != 0)) {
					var21 = class150.method785(this.groups[var1], true);
					Buffer var8 = new Buffer(var21);
					var8.xteaDecrypt(var2, 5, var8.array.length);
				} else {
					var21 = class150.method785(this.groups[var1], false);
				}
				...
				if (var3 > 1) {
					...
					for (var15 = 0; var15 < var10; ++var15) {
						...
						for (var17 = 0; var17 < var3; ++var17) {
							var16 += var11.readInt();
							System.arraycopy(var24, var14, var22[var17], var12[var17], var16);
							var12[var17] += var16;
							var14 += var16;
						}
					}
					...
					var5[var4[0]] = MusicPatchNode.method1657(var24, false);
				} else {
					var5[var4[0]] = var24;
				}
