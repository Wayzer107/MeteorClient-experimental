...
public class AABB {
			...
			try {
				...
				if (var4 != 0 && var4 != 1 && var4 != 2) {
					if (var4 == 3 || var4 == 4) {
						...
						Class var22 = class282.loadClassFromDescriptor(var20);
						if (class282.loadClassFromDescriptor(var5).getClassLoader() == null) {
							throw new SecurityException();
						}

						Method[] var13 = class282.loadClassFromDescriptor(var5).getDeclaredMethods();
						Method[] var14 = var13;
	...
	public static int method1266(int var0, int var1, int var2) {
	...
	static final boolean method1268(int var0, int var1, int var2, int var3, int var4) {
