...
public final class class389 {
	...
	static {
		...
		field3649 = new long[12];

		for (int var0 = 0; var0 < field3649.length; ++var0) {
			field3649[var0] = (long)Math.pow(37.0D, (double)var0);
		}
	...
	static final void method1986(Actor var0) {
		int var2;
		int var3;
		int var4;
		int var6;
		...
		int var7;
		if (var0.pathLength == 0 || var0.field1020 > 0) {
			var7 = -1;
			if (var0.field997 != -1 && var0.field992 != -1) {
				var2 = var0.field997 * 128 - AbstractArchive.baseX * 128 + 64;
				var3 = var0.field992 * 128 - class148.baseY * 128 + 64;
				var4 = var0.x - var2;
		...
		if (var7 != 0) {
			...
			++var0.field1016;
			var4 = var7 > 1024 ? -1 : 1;
			var0.rotation += var4 * var0.field1005;
			boolean var12 = true;
			if (var7 < var0.field1005 || var7 > 2048 - var0.field1005) {
				var0.rotation = var0.orientation;
				var12 = false;
			}

			if (var0.field1005 > 0 && var0.idleSequence == var0.movementSequence && (var0.field1016 > 25 || var12)) {
