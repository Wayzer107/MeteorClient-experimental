...
public class ClanMate extends Buddy {
	...
	static int method2183(int var0) {
		return var0 * 3 + 600;
	}
	...
	@ObfuscatedSignature(
		descriptor = "(II)V",
		garbageValue = "-1681653366"
	)
	static final void method2184(int var0) {
		var0 = Math.min(Math.max(var0, 0), 127);
		class150.clientPreferences.setCurrentSoundEffectVolume(var0);
	}
	...
	static String method2185(String var0) {
		PlayerType[] var1 = PendingSpawn.PlayerType_values();

		for (int var2 = 0; var2 < var1.length; ++var2) {
			PlayerType var3 = var1[var2];
			if (var3.modIcon != -1 && var0.startsWith(SecureRandomCallable.addImageTag(var3.modIcon))) {
