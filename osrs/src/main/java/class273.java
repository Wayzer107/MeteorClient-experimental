...
public class class273 {
	...
	public static int method1504(int var0) {
			...
			if (var7 == null) {
				...
				if (!var6) {
					...
					if (SoundCache.field214 == null) {
						...
						SoundCache.field214 = new ThreadPoolExecutor(0, UserComparator4.field1166, 0L, TimeUnit.MILLISECONDS, new ArrayBlockingQueue(UserComparator4.field1166 * 100 + 100), new class184());
					}
