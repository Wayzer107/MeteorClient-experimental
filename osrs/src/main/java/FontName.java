...
public class FontName {
	...
	static int method2418(int var0, int var1) {
		FloorOverlayDefinition var2 = class131.method718(var0);
		if (var2 == null) {
			return var1;
		} else {
			int var4;
			...
			if (var2.secondaryRgb >= 0) {
				...
				var8 = ClanChannelMember.method770(var7, 96);
				return Rasterizer3D.Rasterizer3D_colorPalette[var8] | -16777216;
			} else if (var2.texture >= 0) {
				int var3 = ClanChannelMember.method770(Rasterizer3D.clips.Rasterizer3D_textureLoader.getAverageTextureRGB(var2.texture), 96);
	...
	public static FontName[] method2419() {
	...
	static class89[] method2420() {
		return new class89[]{class89.field883, class89.field880, class89.field881, class89.field879, class89.field882};
	}
