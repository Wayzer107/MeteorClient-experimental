...
public final class BZip2Decompressor {
	...
	public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3, int var4) {
		synchronized(BZip2Decompressor_state) {
			...
			BZip2Decompressor_state.field4135 = 0;
	...
	static void method2588(BZip2State var0) {
		...
		int var13 = var0.field4135;
		var0.field4135 += var10 - var10;
		if (var0.field4135 < var13) {
		}
		...
		var0.su_ch2 = var5;
		class505.BZip2Decompressor_block = var6;
		var0.field4138 = var7;
	...
	static void BZip2Decompressor_decompress(BZip2State var0) {
		...
		int[] var24 = null;
		int[] var25 = null;
		var0.blockSize100k = -331702915;
		if (class505.BZip2Decompressor_block == null) {
			class505.BZip2Decompressor_block = new int[var0.blockSize100k * -911678688];
		}
				...
				while (true) {
					...
					while (var46 != var42) {
						if (var46 != 0 && var46 != 1) {
							...
							class505.BZip2Decompressor_block[var47] = var0.seqToUnseq[var1 & 255] & 255;
							++var47;
							if (var45 == 0) {
								++var43;
								var45 = 50;
							...
							for (var10000[var1 & 255] += var48; var48 > 0; --var48) {
								class505.BZip2Decompressor_block[var47] = var1 & 255;
								++var47;
							}
						}
					}
					...
					for (var36 = 0; var36 < var47; ++var36) {
						var1 = (byte)(class505.BZip2Decompressor_block[var36] & 255);
						var10000 = class505.BZip2Decompressor_block;
						int var10001 = var0.cftab[var1 & 255];
						var10000[var10001] |= var36 << 8;
						var10002 = var0.cftab[var1 & 255]++;
					}

					var0.field4138 = class505.BZip2Decompressor_block[var0.originalPointer] >> 8;
					var0.nblocks_used = 0;
					var0.field4138 = class505.BZip2Decompressor_block[var0.field4138];
					var0.su_ch2 = (byte)(var0.field4138 & 255);
					var0.field4138 >>= 8;
					++var0.nblocks_used;
					var0.field4144 = var47;
					method2588(var0);
					if (var0.field4144 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) {
						var26 = true;
						break;
					}
