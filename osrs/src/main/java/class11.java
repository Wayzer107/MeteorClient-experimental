...
class class11 implements TlsAuthentication {
	...
	static final void method39() {
		if (!ViewportMouse.ViewportMouse_false0) {
			...
			ViewportMouse.field2228 = (var15 + var17) / 2;
			ViewportMouse.field2227 = (var13 + var11) / 2;
			class151.field1351 = (var18 + var16) / 2;
			class538.field4242 = (var17 - var15) / 2;
			ViewportMouse.field2229 = (var13 - var11) / 2;
			class133.field1281 = (var18 - var16) / 2;
			class90.field886 = Math.abs(class538.field4242);
			class136.field1286 = Math.abs(ViewportMouse.field2229);
			class387.field3645 = Math.abs(class133.field1281);
		}
	}
	...
	static final void method40(PendingSpawn var0) {
		long var1 = 0L;
		int var3 = -1;
		int var4 = 0;
		int var5 = 0;
	...
	static void method41(int var0) {
		SequenceDefinition var1 = class135.SequenceDefinition_get(var0);
		if (var1.isCachedModelIdSet()) {
			if (class273.method1504(var1.SequenceDefinition_cachedModelId) == 2) {
				Client.field605.add(var1.SequenceDefinition_cachedModelId);
			}
