...
public class FriendsChat extends UserList {
	...
	final void method2166(String var1) {
		this.name = MusicPatchPcmStream.method1652(var1);
	}
	...
	final void method2167(String var1) {
		this.owner = MusicPatchPcmStream.method1652(var1);
	}
	...
	public final void method2168(Buffer var1, int var2) {
		this.method2167(var1.readStringCp1252NullTerminated());
	...
	public final void method2169(Buffer var1) {
	...
	public static String method2165(CharSequence var0, LoginType var1) {
		if (var0 == null) {
			return null;
		} else {
			int var2 = 0;
			...
			int var3;
			for (var3 = var0.length(); var2 < var3 && WorldMapArea.method1383(var0.charAt(var2)); ++var2) {
			}

			while (var3 > var2 && WorldMapArea.method1383(var0.charAt(var3 - 1))) {
				--var3;
			}

			int var4 = var3 - var2;
			if (var4 >= 1 && var4 <= DelayFadeTask.method2089(var1)) {
				...
				for (int var6 = var2; var6 < var3; ++var6) {
					...
					if (var8) {
						char var12 = class20.method73(var7);
						if (var12 != 0) {
							var5.append(var12);
						}
					}
