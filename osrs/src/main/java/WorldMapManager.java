...
public final class WorldMapManager {
	...
	public void load(AbstractArchive var1, String var2, boolean var3) {
		if (!this.loadStarted) {
			...
			System.nanoTime();
			int var4 = var1.getGroupId(WorldMapCacheName.field2449.name);
			int var5 = var1.getFileId(var4, var2);
			Buffer var6 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field2449.name, var2));
			Buffer var7 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field2450.name, var2));
			System.nanoTime();
			System.nanoTime();
			...
			System.nanoTime();
			System.nanoTime();
			if (var1.isValidFileName(WorldMapCacheName.field2447.name, var2)) {
				byte[] var20 = var1.takeFileByNames(WorldMapCacheName.field2447.name, var2);
				this.compositeTextureSprite = ClanChannelMember.method769(var20);
			}
	...
	public final void drawTiles(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		float[] var12 = Rasterizer2D.field4171;
		int[] var13 = new int[4];
		...
		Rasterizer3D.method1175(var9, var10, var11, var12);
		...
		for (int var22 = var14.x; var22 < var14.width + var14.x; ++var22) {
			for (int var23 = var14.y; var23 < var14.y + var14.height; ++var23) {
				this.regions[var22][var23].method1405(var5 + (this.regions[var22][var23].regionX * 64 - var20) * var19 / 64, var8 - (this.regions[var22][var23].regionY * 64 - var21 + 64) * var19 / 64, var19);
			}
		}
	...
	public final void drawElements(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, HashSet var9, HashSet var10, int var11, int var12, boolean var13) {
		...
		for (var19 = var14.x; var19 < var14.width + var14.x; ++var19) {
			for (var20 = var14.y; var20 < var14.height + var14.y; ++var20) {
				...
				this.regions[var19][var20].method1416(var5 + (this.regions[var19][var20].regionX * 64 - var17) * var16 / 64, var8 - (this.regions[var19][var20].regionY * 64 - var18 + 64) * var16 / 64, var16, var9);
			}
		}
	...
	public List method1447(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		...
		if (!this.loaded) {
			...
			for (int var17 = var12.x; var17 < var12.width + var12.x; ++var17) {
				for (int var18 = var12.y; var18 < var12.height + var12.y; ++var18) {
					List var19 = this.regions[var17][var18].method1437(var5 + (this.regions[var17][var18].regionX * 64 - var15) * var14 / 64, var8 + var6 - (this.regions[var17][var18].regionY * 64 - var16 + 64) * var14 / 64, var14, var9, var10);
					if (!var19.isEmpty()) {
						var11.addAll(var19);
					}
				}
	...
	static void method1440(int var0) {
		class450.field3851 = var0;
		class450.field3852 = new class450[var0];
		class344.field3132 = 0;
	}
	...
	public static final void method1442(int var0, boolean var1, int var2) {
		if (var0 >= 8000 && var0 <= 48000) {
			PcmPlayer.field181 = var0;
			class373.PcmPlayer_stereo = var1;
			ObjTypeCustomisation.field1482 = var2;
		} else {
	...
	public static void method1453(Widget var0, PlayerComposition var1, boolean var2) {
		var0.modelType = 7;
		var0.field3081 = new PlayerComposition(var1);
		if (!var2) {
			var0.field3081.equipment = Arrays.copyOf(var0.field3081.field2894, var0.field3081.field2894.length);
			...
			if (Client.minimapState != 2 && Client.minimapState != 5) {
				...
				for (var8 = 0; var8 < 104; ++var8) {
					for (var9 = 0; var9 < 104; ++var9) {
						NodeDeque var15 = Client.groundItems[class36.Client_plane][var8][var9];
						if (var15 != null) {
				...
				for (var10 = 0; var10 < var8; ++var10) {
					...
					if (var11 != null && var11.isVisible() && !var11.isHidden && var11 != class136.localPlayer) {
