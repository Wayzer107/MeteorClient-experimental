...
public abstract class class143 extends Node {
	...
	static final void method761(Widget var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (Client.field378) {
		...
		int var7;
		if (MouseHandler.MouseHandler_currentButton == 1 || !class28.mouseCam && MouseHandler.MouseHandler_currentButton == 4) {
